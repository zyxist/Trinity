...
class Style extends Container
{
	...
	/**
	 * Base URL for local styles.
	 * @var String
	 */
	protected $_baseUrl;

	/**
	 * Sets base URL for local styles.
	 *
	 ...
	 */
	public function prependFile($file, $local = true, $type = 'text/css', $options = array())
	{
		if((bool)$local)
		{
	 ...
	 * @param Array $options Extra options
	 */
	public function appendFile($file, $local = true, $type = 'text/css', $options = array())
	{
		if((bool)$local)
		{
			$file = $this->_baseUrl.$file;
	 ...
	 * @param Array $options Extra options
	 */
	public function offsetSetFile($offset, $file, $local = true, $type = 'text/css', $options = array())
	{
		if((bool)$local)
		{
			$file = $this->_baseUrl.$file;
