...
use \Trinity\Basement\Model;
use \IteratorAggregate;
use \ArrayIterator;

/**
 * Represents a single session namespace where the user is allowed to store
 * the data. Note that the namespace is a valid model, so it can be exlicitely
 * accessed by views.
 *
 ...
 */
class Session_Namespace implements IteratorAggregate, Model
{
	/**
	...
	/**
	 * Constructs the session namespace. Note that you should not call this
	...
	/**
	 * Validates the namespace data within <tt>$_SESSION</tt> table, optionally
