...
class Layout implements Broker
{
	 ...
	 * 
	 * @param \Symfony\Component\EventDispatcher\EventDispatcher $eventDispatcher Event dispatcher.
	 */
	...
	public function display()
	{
		...
		$this->_eventDispatcher->notify(new Event($this, 'template.layout.configure',
		...
		$this->_eventDispatcher->notify(new Event($this, 'template.layout.render',
			array('layout' => $this->_layout)
		));
