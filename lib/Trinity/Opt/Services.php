...
class Services extends Container
{
	...
	public function getOptService(ServiceLocator $serviceLocator)
	{
		...
		$opt->register(Opt_Class::OPT_FORMAT, 'Helper', '\Trinity\Opt\Format\Helper');
	...
	public function getStyleService(ServiceLocator $serviceLocator)
	{
		$style = new \Trinity\Opt\Helper\Style();
	...
	public function getScriptService(ServiceLocator $serviceLocator)
	{
		$script = new \Trinity\Opt\Helper\Script();
